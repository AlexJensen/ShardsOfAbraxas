...
{
    [CreateAssetMenu(fileName = "New Target Property Of Target", menuName = "Abraxas/StoneData/Targets/Target Property Of Target")]
    class Target_PropertyOfTarget : TargetSO<object>
    {
        ...
        private Type ResolveTargetType(TargetSOBase targetObject)
        {
            ...
            if (targetObject is Target_TriggeringObject triggeringObject)
            {
            ...
            if (targetObject is Target_PropertyOfTarget nestedPropertyTarget)
            {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(Target_PropertyOfTarget))]
    public class Target_PropertyOfTargetEditor : StoneSOEditor
    {
        ...
        private Type ResolveTargetType(TargetSOBase targetObject)
        {
            ...
            if (targetObject is Target_PropertyOfTarget nestedPropertyTarget && nestedPropertyTarget._targetObject != null && !string.IsNullOrEmpty(nestedPropertyTarget._propertyName))
            {
                return ResolveTargetType(nestedPropertyTarget._targetObject).GetProperty(nestedPropertyTarget._propertyName).PropertyType;
            }
