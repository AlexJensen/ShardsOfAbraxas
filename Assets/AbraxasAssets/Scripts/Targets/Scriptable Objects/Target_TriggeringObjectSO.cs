...
[CreateAssetMenu(fileName = "New Target TriggeringObject", menuName = "Abraxas/Data/StoneData/Targets/TriggeringObject")]
class Target_TriggeringObjectSO : TargetSO<IEvent>
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(Target_TriggeringObjectSO))]
