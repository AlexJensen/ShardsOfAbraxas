...
{
    public class Trigger_StartOfOpponentTurn : Trigger_StartOfState
    {
        #region Dependencies
        readonly IPlayerManager _playerManager;
        public Trigger_StartOfOpponentTurn(PlayerManager playerManager)
        {
        ...
        {
            return eventData.State is BeginningState && Card.Zone is FieldController && Card.Owner != _playerManager.ActivePlayer;
        }
        #endregion
    }
}
