...
{
    [CreateAssetMenu(fileName = "New Target OwnerOfCard", menuName = "Abraxas/StoneData/Targets/OwnerOfCard")]
    class Target_OwnerOfTargetCard : TargetSO<Player>
    {
...
#if UNITY_EDITOR
        [CustomEditor(typeof(Target_OwnerOfTargetCard))]
